...
import { ServerInfo, defaultServerInfo, validateServerField } from '@/models/ServerInfo';
...
const AddServerForm: React.FC<AddServerFormProps> = ({ onSubmit, onCancel }) => {
    ...
    const handleChange = (field: keyof ServerInfo) => (
        e: React.ChangeEvent<HTMLInputElement>
    ) => {
        const value = field === 'port' ? parseInt(e.target.value) || 0 : e.target.value;
